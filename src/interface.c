...
emacs_value em_libgit_object_p, em_libgit_repository_p, em_libgit_reference_p, em_signature_p;
emacs_value em_repository, em_reference, em_commit, em_tree, em_blob, em_tag, em_object, em_signature;
