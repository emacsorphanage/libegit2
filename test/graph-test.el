(ert-deftest ahead-behind ()
  (let (c1 c2 c3 c4 c5 c6 c7)
    (with-temp-dir path
      (init)
      (commit-change "a" "1")
      (setq c1 (run-nnl "git" "rev-parse" "HEAD"))
      (run "git" "checkout" "-b" "branch")
      (commit-change "a" "2")
      (setq c2 (run-nnl "git" "rev-parse" "HEAD"))
      (commit-change "a" "3")
      (setq c3 (run-nnl "git" "rev-parse" "HEAD"))
      (commit-change "a" "4")
      (setq c4 (run-nnl "git" "rev-parse" "HEAD"))
      (run "git" "checkout" "master")
      (commit-change "a" "5")
      (setq c5 (run-nnl "git" "rev-parse" "HEAD"))
      (commit-change "a" "6")
      (setq c6 (run-nnl "git" "rev-parse" "HEAD"))
      (commit-change "a" "7")
      (setq c7 (run-nnl "git" "rev-parse" "HEAD"))
