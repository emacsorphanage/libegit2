    ...
    (let (id1 id2 id3)
      ...
      (let* ((repo (libgit-repository-open path))
        ...
        (let ((e1 (libgit-reflog-entry-byindex log 0))
          ...
          (should (string= id2 (libgit-reflog-entry-id e1 'old)))
          (should (string= id2 (libgit-reflog-entry-id e2 'new)))
          (should (string= id1 (libgit-reflog-entry-id e2 'old)))
          (should (string= id1 (libgit-reflog-entry-id e3 'new)))
          (should (string= (make-string 40 ?0) (libgit-reflog-entry-id e3 'old))))))))
    ...
    (with-temp-dir path
      ...
      (let* ((repo (libgit-repository-open path))
        ...
        (let* ((newlog (libgit-reflog-read repo "HEAD"))
          ...
          (should (string= id (libgit-reflog-entry-id entry 'old)))
    ...
    (with-temp-dir path
      ...
      (let* ((repo (libgit-repository-open path))
        ...
        (let ((e1 (libgit-reflog-entry-byindex log1 0))
          ...
          (should (string= id3 (libgit-reflog-entry-id e1 'new)))
          (should (string= id1 (libgit-reflog-entry-id e1 'old)))
          (should (string= id1 (libgit-reflog-entry-id e2 'new)))
          (should (string= (make-string 40 ?0) (libgit-reflog-entry-id e2 'old))))
